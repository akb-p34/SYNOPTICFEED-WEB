...
const FROM = process.env.RESEND_FROM_EMAIL || 'SynopticFeed <onboarding@resend.dev>';
const NOTIFY_TO = process.env.NOTIFY_TO_EMAIL || 'akbar.pathan034@gmail.com';
...
We're capping founding at ten desks. I read every request myself, and I'll reply within one business day with a few questions about your desk and what you trade, so I can tell you honestly whether we're a fit.
...
<p>We're capping founding at ten desks. I read every request myself, and I'll reply within one business day with a few questions about your desk and what you trade, so I can tell you honestly whether we're a fit.</p>
...
module.exports = { sendWelcome, sendNotification };
